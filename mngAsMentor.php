 ...
 <header style = "background-image: url(assets/bg_whitepattern.jpg)">
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					...
					<H2 style = "text-align: center!important; font-weight: bold;"> AS A <span style =  "color: #7f0000"> MENTOR </span></H2>
					</center>
					<div class="card-body">
						<div class="row">
							<div class="col-sm-12">
  ...
  <section class = "section-1" style = "background-image: url(assets/cream_pixels.png)">
	<div class="container">
		...
		<div class="row">
			<div class="col-4">
				<a href="#" class="btn btn-lg mb-3" id = "delAll" style = "width: 100%; border: 2px solid gray"> 
			...
			<div class="col-4">
				<a href="#" class="btn btn-lg mb-3" id = "disAll" style = "width: 100%; color: white; background-color: gray"> 
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
					  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293 5.354 4.646z"/>
					</svg>
					DISABLE ALL SESSION</a>
			</div>
			<div class="col-4">
				<a href="#" class="btn btn-lg mb-3" id = "addMen" style = "width: 100%; background-color: #ffb81d; color: white">
